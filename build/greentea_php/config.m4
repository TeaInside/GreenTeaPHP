...
if test "$PHP_GREENTEA" != "no"; then
  ...
  PHP_NEW_EXTENSION(greentea, app_entry.compiled.cpp greentea_php.compiled.c classes/GreenTea/GreenTea.compiled.cpp helpers/global.c helpers/pcre.c helpers/php.c, $ext_shared,, "-Wall")
